    ...
    <div className="relative w-full bg-white text-neutral-900 min-h-screen font-sans selection:bg-indigo-200 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full pt-32 pb-24 min-h-[110vh] bg-white flex flex-col items-center border-b border-neutral-200 shadow-md rounded-b-3xl">
        <div className="max-w-3xl mx-auto px-6 w-full">
          ...
          <p className="text-neutral-500 text-sm mb-12">Last updated: May 31, 2026</p>
          ...
          <div className="space-y-10 text-neutral-700 leading-relaxed">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-neutral-900">2. Description of Service</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-neutral-900">3. Not an Official Application</h2>
              <p className="bg-amber-50 border border-amber-200 p-4 rounded-2xl text-amber-800 font-medium text-sm">
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-neutral-900">4. User Account Security</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-neutral-900">5. Limitation of Liability</h2>
              <p>
