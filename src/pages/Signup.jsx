    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4 py-8">
      <div className="w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          />
          <h1 className="text-2xl font-bold text-neutral-900">Join SIMATS AM</h1>
          <p className="text-neutral-500 mt-1">Start tracking your attendance today</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-emerald-500 text-neutral-900 placeholder-neutral-500"
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-600 mb-2">Roll Number</label>
              <div className="relative">
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-600 mb-2">University Email</label>
            <div className="relative">
          ...
          <div>
            <label className="block text-sm font-medium text-neutral-600 mb-2">University/College</label>
            <div className="relative">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 bg-white border border-gray-200 rounded-xl focus:outline-none focus:border-emerald-500 text-neutral-900 placeholder-neutral-500"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-emerald-500 hover:bg-emerald-600 text-neutral-900 font-semibold py-3.5 px-6 rounded-xl transition-colors flex items-center justify-center gap-2 disabled:opacity-50 mt-6"
          >
            {loading ? (
