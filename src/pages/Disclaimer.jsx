...
const Disclaimer = () => {
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-neutral-50 dark:bg-black text-neutral-900 dark:text-neutral-100 p-4 md:p-8 transition-colors duration-300">
      <div className="max-w-3xl mx-auto space-y-4">
        {/* Header */}
        <div className="disclaimer-card bg-gradient-to-br from-amber-500/10 to-orange-500/5 dark:from-amber-500/20 dark:to-orange-500/10 border border-amber-500/20 dark:border-amber-500/30 rounded-2xl p-6 relative overflow-hidden">
          ...
          <div className="flex items-center gap-4 relative">
            ...
            <div>
              <h1 className="text-2xl font-bold text-amber-950 dark:text-white">Important Disclaimer</h1>
              <p className="text-amber-800 dark:text-amber-200/70 text-sm">Please read carefully before using</p>
            </div>
          </div>
        </div>

        {/* Not Official */}
        <div className="disclaimer-card bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-red-500/10 rounded-lg flex items-center justify-center shrink-0">
              <XCircle size={20} className="text-red-500 dark:text-red-400" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">Not an Official College Application</h2>
              <p className="text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed mb-3">
                <strong className="text-neutral-800 dark:text-white">Student Attendance Manager (SAM)</strong> is an independent student project 
                created by <span className="text-emerald-500 dark:text-emerald-400 font-medium">VIGNESH</span> to help students track and manage 
                their attendance effectively.
              </p>
              <p className="text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed mb-2">
                This application is <span className="text-red-500 dark:text-red-400 font-semibold">NOT affiliated</span> with, endorsed by, 
        ...
        <div className="disclaimer-card bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center shrink-0">
              <Heart size={20} className="text-emerald-500 dark:text-emerald-400" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-white mb-2">Purpose of This Project</h2>
              <p className="text-neutral-600 dark:text-neutral-400 text-sm leading-relaxed mb-2">
        ...
        <div className="disclaimer-card bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-white mb-3">Data Privacy & Security</h2>
              ...
              <div className="mt-3 p-3 bg-blue-500/5 dark:bg-blue-500/10 border border-blue-500/10 dark:border-blue-500/20 rounded-lg">
                <p className="text-xs text-blue-800 dark:text-blue-300">
                  <strong>Email Sharing:</strong> Your email is shared with matrixortai.ltd for essential app updates only.
                  <span className="text-blue-600 dark:text-blue-400"> (Not for spam or promotion)</span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="disclaimer-card bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5 hover:border-neutral-300 dark:hover:border-neutral-700 transition-colors">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-lg font-semibold text-neutral-900 dark:text-white mb-3">Limitations & Responsibilities</h2>
              <div className="grid sm:grid-cols-2 gap-2">
                {[
                  ...
                  <div key={i} className="flex items-center gap-2 text-sm text-neutral-600 dark:text-neutral-400">
                    <div className="w-1.5 h-1.5 bg-amber-500 dark:bg-amber-400 rounded-full shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
        ...
        {/* Acknowledgment */}
        <div className="disclaimer-card bg-gradient-to-br from-emerald-500/5 to-teal-500/5 dark:from-emerald-500/10 dark:to-teal-500/5 border border-emerald-500/10 dark:border-emerald-500/20 rounded-2xl p-5">
          <div className="flex items-start gap-4">
            <div className="w-10 h-10 bg-emerald-500/20 rounded-lg flex items-center justify-center shrink-0">
              <Sparkles size={20} className="text-emerald-500 dark:text-emerald-400" />
            </div>
            <div>
              <h2 className="text-lg font-semibold text-emerald-950 dark:text-white mb-2">By Using This App, You Acknowledge</h2>
        ...
        {/* Contact */}
        <div className="disclaimer-card bg-white dark:bg-neutral-900/80 border border-neutral-200 dark:border-neutral-800 rounded-2xl p-5">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="flex items-center gap-2 bg-neutral-100 hover:bg-neutral-200 dark:bg-neutral-800 dark:hover:bg-neutral-700 text-neutral-900 dark:text-white px-4 py-2.5 rounded-xl transition-colors text-sm"
            >
              <Mail size={16} />
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-600 mt-3">
