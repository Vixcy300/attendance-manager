    ...
    <div className="relative w-full bg-white dark:bg-black text-neutral-900 dark:text-neutral-100 min-h-screen font-sans selection:bg-indigo-200 overflow-x-hidden">
      ...
      <main className="relative z-10 w-full pt-32 pb-24 min-h-[110vh] bg-white dark:bg-black flex flex-col items-center border-b border-neutral-200 dark:border-neutral-800 shadow-md rounded-b-3xl">
        <div className="max-w-3xl mx-auto px-6 w-full">
          ...
          <p className="text-neutral-500 dark:text-neutral-400 text-sm mb-12">We would love to hear your feedback, feature requests, or queries.</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-6 rounded-3xl shadow-sm space-y-4">
              ...
              <h2 className="text-xl font-bold text-neutral-900 dark:text-white">Email</h2>
              <p className="text-neutral-500 dark:text-neutral-400 text-sm">For support, inquiries, and bug reports, drop us an email.</p>
            ...
            <div className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-6 rounded-3xl shadow-sm space-y-4">
              ...
              <h2 className="text-xl font-bold text-neutral-900 dark:text-white">Feedback Portal</h2>
              <p className="text-neutral-500 dark:text-neutral-400 text-sm">Submit and upvote feature requests or report issues directly in our app portal.</p>
              <Link to="/feedback" className="text-indigo-600 font-semibold hover:underline block text-sm">Go to Feedback Portal</Link>
            </div>
          </div>

          <div className="bg-neutral-50 dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 p-8 rounded-3xl shadow-sm flex items-start gap-4">
            <div className="w-10 h-10 bg-indigo-100 dark:bg-indigo-950/20 rounded-xl flex items-center justify-center text-indigo-600 flex-shrink-0">
              <MapPin size={20} />
            </div>
            <div>
              <h3 className="font-bold text-neutral-900 dark:text-white mb-2">Location</h3>
