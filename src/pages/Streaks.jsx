    ...
    <div ref={containerRef} className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-2">
            {isEditing ? (
              <>
                ...
                <button onClick={handleCancelEdit} className="p-2 bg-gray-100 hover:bg-neutral-700 rounded-lg transition-colors">
                  <X size={18} className="text-neutral-900" />
                </button>
              </>
            ) : (
              <>
                <button onClick={handleStartEdit} className="p-2 bg-gray-100 hover:bg-neutral-700 rounded-lg transition-colors" title="Edit streaks">
                  <Edit3 size={18} className="text-neutral-500" />
                </button>
                <button onClick={handleResetStreaks} className="p-2 bg-gray-100 hover:bg-neutral-700 rounded-lg transition-colors" title="Reset streaks">
          ...
          <div className="flex items-center gap-3 p-3 bg-gradient-to-r from-violet-500 to-purple-600 rounded-xl">
            <div className="w-10 h-10 bg-white/20 rounded-lg flex items-center justify-center">
              <span className="text-lg font-bold text-neutral-900">{level}</span>
            </div>
            <div>
      ...
      <div className="streak-card flex flex-wrap gap-3">
        <button
          ...
          className="flex items-center gap-2 bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-neutral-900 px-4 py-2.5 rounded-xl transition-all hover:scale-105 shadow-lg shadow-orange-500/25"
        >
        ...
        <button
          ...
          className="flex items-center gap-2 bg-gray-100 hover:bg-neutral-700 text-neutral-900 px-4 py-2.5 rounded-xl transition-colors"
        >
          <Minus size={18} />
          Missed a Day
        </button>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        <div className="streak-card bg-gradient-to-br from-orange-500 to-red-500 rounded-xl p-4 text-neutral-900 relative overflow-hidden">
        ...
        <div className="streak-card bg-gradient-to-br from-amber-500 to-yellow-500 rounded-xl p-4 text-neutral-900 relative overflow-hidden">
          <div className="absolute top-2 right-2 opacity-20">
            <Trophy size={48} />
          </div>
        ...
        <div className="streak-card bg-gradient-to-br from-emerald-500 to-teal-500 rounded-xl p-4 text-neutral-900 relative overflow-hidden">
          <div className="absolute top-2 right-2 opacity-20">
            <TrendingUp size={48} />
          </div>
        ...
        <div className="streak-card bg-gradient-to-br from-blue-500 to-indigo-500 rounded-xl p-4 text-neutral-900 relative overflow-hidden">
          <div className="absolute top-2 right-2 opacity-20">
            <Calendar size={48} />
          </div>
      ...
      {/* Custom Goals */}
      <div className="streak-card bg-white border border-gray-200 rounded-xl p-4">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <Target className="text-emerald-400" size={20} />
            <h2 className="font-semibold text-neutral-900">Custom Goals</h2>
          </div>
          <button
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-4 border border-gray-200">
            <div className="flex flex-wrap gap-3">
              <input
                ...
                className="flex-1 min-w-[200px] bg-white border border-gray-200 rounded-lg px-3 py-2 text-neutral-900 text-sm focus:outline-none focus:border-emerald-500"
              />
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 bg-white border border-gray-200 rounded-lg px-2 py-2 text-neutral-900 text-sm text-center focus:outline-none focus:border-emerald-500"
                />
                <span className="text-neutral-500 text-sm">%</span>
              </div>
              <button
                onClick={handleAddGoal}
                className="bg-emerald-500 hover:bg-emerald-600 text-neutral-900 px-4 py-2 rounded-lg text-sm transition-colors"
              >
                Add
              </button>
            </div>
              ...
              <div key={goal.id} className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`font-medium ${goal.completed ? 'text-emerald-400' : 'text-neutral-900'}`}>{goal.name}</span>
                  </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      className="p-1.5 bg-gray-100 hover:bg-neutral-700 rounded-lg transition-colors"
                    >
      ...
      <div className="streak-card bg-white border border-gray-200 rounded-xl p-4">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="font-semibold text-neutral-900">Achievements</h2>
            ...
            <div
              ...
              className={`p-4 rounded-xl border transition-all ${
                achievement.unlocked 
                  ...
                  : 'border-dashed border-gray-200 bg-neutral-900/50'
              }`}
            >
              <div className="flex items-start gap-3">
                <div className={`p-2.5 rounded-xl ${achievement.unlocked ? colorMap[achievement.color] : 'bg-gray-100'}`}>
                  <achievement.icon className="text-neutral-900" size={18} />
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className={`font-medium text-sm ${achievement.unlocked ? 'text-neutral-900' : 'text-neutral-500'}`}>
                    {achievement.title}
                  </h3>
