...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 lg:left-64 z-30 bg-white/90 backdrop-blur-md border-b border-gray-200">
      <div className="flex items-center justify-between px-3 sm:px-4 md:px-6 py-3">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            className="flex items-center gap-2 p-1.5 sm:p-2 sm:pr-3 hover:bg-white rounded-lg transition-colors"
          >
            <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-500 flex items-center justify-center text-neutral-900 font-semibold text-sm">
