    ...
    <div className="fixed inset-0 bg-gray-900/40 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white border border-gray-200 rounded-xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-200">
          <h2 className="font-semibold text-neutral-900">Quick Calculator</h2>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="0"
                className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-neutral-900 text-center text-lg focus:outline-none focus:border-emerald-500"
              />
            </div>
            <div>
          ...
          <div>
            <label className="block text-sm text-neutral-500 mb-1.5">Target %</label>
            <input
              type="number"
              min="0"
              max="100"
              ...
              className="w-full px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-neutral-900 text-center focus:outline-none focus:border-emerald-500"
            />
          </div>

          <button
            onClick={calculateResult}
            className="w-full bg-emerald-500 hover:bg-emerald-600 text-neutral-900 py-2 rounded-lg transition-colors"
          >
            Calculate
          </button>
          ...
          {result && (
            <div className="space-y-3 pt-2 border-t border-gray-200">
              ...
              {result.predictiveMessage && (
                <p className="text-sm text-neutral-500 text-center bg-gray-50 rounded-lg p-3">
                  {result.predictiveMessage}
                </p>
              )}
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 bg-gray-100 hover:bg-neutral-700 text-neutral-900 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm"
                >
                ...
                <button
                  ...
                  className="flex-1 bg-emerald-500 hover:bg-emerald-600 text-neutral-900 py-2 rounded-lg transition-colors flex items-center justify-center gap-2 text-sm"
                >
                  <Save size={14} /> Save
                </button>
              </div>
